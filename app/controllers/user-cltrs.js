...
userCltrs.register = async (req, res)=>{
  ...
  try{
    ...
    transporter.sendMail({
      ...
      text: `Hello ${user.firstName}!, Welcome to Service At Your Home Family. Click the following link to verify your email: http://localhost:3699/api/verify-email/${encryptedUserId}`,
      html: `
        <p>Hello ${user.firstName}!,</p>
        <p>Welcome to Service At Your Home Family. Please click the link below to verify your email:</p>
        <p><a href='http://localhost:3699/api/verify-email/${encryptedUserId}'>Click here to verify your email.</a></p>
      `
    })    
